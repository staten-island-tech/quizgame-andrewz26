...
const questions = [
  {
    question: 'Who is the better basketball player?',
    answers: [
  ...
  },
  {
    ...
    answers: [
      { text: 'Saquon Barkley', correct: true },
      { text: 'Christian McCaffrey', correct: false },
  ...
  },
  {
    question: 'Whos doper?',
    answers: [
      { text: 'Andrew Zaw', correct: false },
      { text: 'Mr. Whalen', correct: true }
    ]
  }
]